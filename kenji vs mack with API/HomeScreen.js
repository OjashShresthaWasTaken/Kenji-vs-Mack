function openRules() {
  ...
  alert('node.js should be installed and u should execute "node server.js" in the terminal for the local rest API to work and access the image and audio files');